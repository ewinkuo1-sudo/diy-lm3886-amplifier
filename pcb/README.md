...
**現行版本是 V0.4**（2026-09-24：放大板變體 D 為主、變體 C 保留、電源板加每聲道端子與 snubber 預留位），三板 KiCad 10.0.6 DRC 0 違規、0 未連通，見下方「PCB V0.4」各節。**V0.3 自 2026-09-24 起為歷史版本**：板檔、DRC、雜湊綁定與審查結論原樣保留供對照，不再修改。
