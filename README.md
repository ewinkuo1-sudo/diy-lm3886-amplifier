...
採兩片相同的 **90 × 80 mm 單聲道板**＋一片 **150 × 110 mm 共用電源板**。封裝、接地與載流仍待確認，不可直接製造；放大板尚有 14 個未連通項目。

![PCB 三板配置](pcb/preview/system-placement-overview.png)

[可編輯 PCB、檢查結果與待修改事項](pcb/README.md)。下方 V0.3 PDF 為加入 PCB 前的圖面快照。
