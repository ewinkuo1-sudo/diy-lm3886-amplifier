...
## PCB B 方案修訂（V0.2／2026-09-17）

使用者選定 B 方案並確認 **LM3886T 與變壓器仍在寄送中，尚未收到**。保留三板架構，重整元件位置、輸入／回授、分路接地、整流充電與輸出取電路徑。

兩片 **100 × 90 mm 單聲道板**＋一片 **160 × 120 mm 共用電源板**。以 KiCad 10.0.6 及本版 0.3 mm 最小銅箔間距檢查，兩板均 **0 DRC 違規、0 未連通項目**；54＋35 個電氣焊盤網路對照通過。封裝、載流溫升及機構尚待實物確認，**仍不可直接製造**。

![PCB B 方案三板配置](pcb/preview/system-layout-v02.png)

[新版可編輯 PCB、修改說明與驗證](pcb/README-v02.md)；[V0.1 歷史說明](pcb/README-v01.md)。原理圖與下方 V0.3 PDF 未變更，PDF 尚未收錄本次 PCB 修訂。
