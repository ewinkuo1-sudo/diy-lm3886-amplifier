...
- **2026-09-23 已量三款電解與變壓器機構尺寸**（見採購總表 §1）：381LX Ø35×50、2 腳、腳距 10（A05 殼尺寸）；EKE Ø12×25、腳距 5；EGW 軸向 40×Ø20，**改躺式 P50 封裝，放大板因此由 100×90 加寬為 115×90 mm**（生成器已改、板檔未重建）。變壓器 Ø120×約 50（含出線）、中心孔 Ø40、8 條出線。繞組電氣量測未做。
