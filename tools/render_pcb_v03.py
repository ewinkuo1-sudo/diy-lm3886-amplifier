...
def draw_board(im,data,origin,scale,show_pending=True):
 ...
 d.text(point(w/2,h-7),'V0.3 B / ENGINEERING DRAFT',font=font(1.65*scale),fill='#e3f4e9',anchor='mm')
 return d

mono=json.loads((D/'mono-layout-v03.json').read_text(encoding='utf-8'))
