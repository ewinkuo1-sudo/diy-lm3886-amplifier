...
STAR_CHECK={'mono-layout-v04c'}   # PSU returns join at the capacitor banks by design (as in V0.3); D uses a pour
for name,source in [('mono-layout-v04c','netlist.xml'),('mono-layout-v04d','netlist.xml'),('psu-layout-v04','psu-netlist.xml')]:
 ...
 if name not in STAR_CHECK and not data.get('zones'):
...
report['sha256']={f.relative_to(R).as_posix():hashlib.sha256(f.read_bytes()).hexdigest() for f in [R/'pcb/mono-layout-v04c.kicad_pcb',R/'pcb/mono-layout-v04c.kicad_pro',R/'pcb/mono-v04c-drc.json',R/'pcb/mono-layout-v04d.kicad_pcb',R/'pcb/mono-layout-v04d.kicad_pro',R/'pcb/mono-v04d-drc.json',R/'pcb/psu-layout-v04.kicad_pcb',R/'pcb/psu-layout-v04.kicad_pro',R/'pcb/psu-v04-drc.json',R/'electrical/lm3886-v01.kicad_sch',R/'electrical/internal-psu-v02.kicad_sch']}
