...
},anchors={'STAR':(110,59.08)},labels=[('2x22VAC / V0.3 B',40,57),('<- 4 FASTON WIRES',48,36),('BR1 KBPC2510 ON CHASSIS',48,40),('<- 4 FASTON WIRES',48,96),('BR2 KBPC2510 ON CHASSIS',48,100),('GND STAR',110,64),('V+',157.5,54),('G',157.5,59.08),('V-',157.5,64.16),('SECONDARY ONLY',42,115)],routes=[
