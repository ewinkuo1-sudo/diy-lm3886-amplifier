...
for key in ['mono','psu']:
 ...
 for c in data['parts']:
  ...
  ORDERED={'U1':'已訂（拆機）到貨未回報；封裝未核對','C1':'已購 WIMA MKS4 100V 已到貨待量','C2':'已購 ROE EGW 已量 L40×Ø20；改躺式 P50 封裝，放大板加寬至 115 mm','C3':'已購 WIMA MKS2 100V 已到貨待量','C4':'已購 WIMA MKS2 100V 已到貨待量','C5':'已購 WIMA MKS2 100V 已到貨待量','C6':'已購 ROE EKE 已到貨待量；量直徑腳距','C7':'已購 ROE EKE 已到貨待量；量直徑腳距','C8':'已購 CDE 361R 100V 已到貨待量；量直徑','R1':'已購 MRS25 已到貨待量','R2':'已購 MRS25 已到貨待量','R3':'已購 MRS25 已到貨待量','R4':'已購 MRS25 已到貨待量','R5':'已購 RNU2 已到貨待量','R6':'已購 MRS25 已到貨待量','R7':'已購 PR02 已到貨待量','R8':'已購 MRS25 0.6W 已到貨待量','C201':'已購 CDE 381LX 已到貨待量；量直徑高度腳距','C202':'已購 CDE 381LX 已到貨待量；量直徑高度腳距','C203':'已購 CDE 381LX 已到貨待量；量直徑高度腳距','C204':'已購 CDE 381LX 已到貨待量；量直徑高度腳距','C205':'已購 WIMA MKS2 100V 已到貨待量','C206':'已購 WIMA MKS2 100V 已到貨待量','R201':'已購 PR02 已到貨待量','R202':'已購 PR02 已到貨待量'}
