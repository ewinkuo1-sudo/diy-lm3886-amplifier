...
ns={"__file__":str(R/"tools/render_pcb_v03.py")};exec(src[:src.index("mono=json.loads")].replace('V0.3 B / ENGINEERING DRAFT','V0.4 C / ENGINEERING DRAFT'),ns)   # only the helpers, not the V0.3 render pass
draw_board,font=ns['draw_board'],ns['font']
for name,title in [('mono-layout-v04c','單聲道放大板 / 方案 C・V0.4 變體 C（改良星型接地）')]:
 ...
 for key,col in [('STAR','#fff3aa'),('SG','#9ad7ff')]:
 ...
 y=120+h*scale+28;d.text((80,y),'橘：頂層銅箔　藍：底層銅箔　黃圈：接地匯流點 STAR　藍圈：訊號地 SG',font=font(20),fill='#bdd1d2')
