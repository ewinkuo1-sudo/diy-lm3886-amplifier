...
- **PCB**：V0.3 為**工程草稿，不可送製**。兩片 100×90 mm 單聲道板＋一片 160×120 mm 電源板，KiCad 10.0.6 下 0 DRC 違規、0 未連通，54＋35 焊盤網路對照通過。封裝為暫定外框與假設高度，溫升、散熱、機構與線束都沒驗證。V0.1／V0.2 已歸檔在 `pcb/archive/`。
...
逐日進度、各版 PCB 與採購的完整歷史見 [CHANGELOG.md](CHANGELOG.md)。歷史採購附錄在 [docs/archive/](docs/archive/)。
