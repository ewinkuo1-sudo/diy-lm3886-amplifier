...
- [docs/11-ruten-shopping-links.md](docs/11-ruten-shopping-links.md)整合38個已開啟核對的商品直達頁：原15項＋新增23項；docs/10的原表與JSON也補上連結／包裝選項。
...
- docs/10-planned-parts.md／json保存15個候選條目、40個不重複元件位置、原文價格／出貨描述及完整料號。兩個替代群組不重複計量。
